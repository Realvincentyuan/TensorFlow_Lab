...
# Split the data: It's good practice to use a validation split when developing your model.
...
# note: the normalization_layer can be directly applied in dataset, or it can be put in a model as the first layer
